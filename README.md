...
```sh
wget https://github.com/shad0wfax-de/script.moonlight-embedded-launcher-matrix/archive/refs/tags/v1.1-matrix.zip -O script.moonlight-embedded-launcher-matrix-1.1.zip
```
```
